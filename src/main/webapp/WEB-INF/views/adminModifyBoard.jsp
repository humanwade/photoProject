                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminUpdateBoard" method='post'>
                                	<input type="hidden" name="anNumber" value="${board.anNumber}" />
                                	<table >
                                		<tr>
                                			<td>관리자 아이디 :</td>
                                		...
                                		<tr>
                                			<td>내용</td>
                                			<td><textarea cols='100' rows='15' name="anContent">${board.anContent }</textarea></td>
                                		</tr>
                                		<tr>
