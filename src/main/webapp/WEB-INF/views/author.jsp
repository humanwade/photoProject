...
<html data-wf-page="6634a93befaafa41dc30c14c" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Author | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Author | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Author | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  ...
  <div style="opacity:0" class="pages-wrapper">
                        ...
                        <div class="pages-dropdown-flex">
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="page-dropdown-list-flex-wrap">
                              ...
                              <div class="dropdown-list-wrapper">
                                <a href="author.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                  <div>Author</div>
                                </a>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Authors</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="author.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Authors</div>
            </a>
          </div>
        </div>
    ...
    <section class="section member">
      <div class="container">
        <div class="member-collection-wrapper">
          <div class="w-dyn-list">
            <div role="list" class="member-collection-grid w-dyn-items">
              <div role="listitem" class="w-dyn-item">
                <div class="single-member-wrapper">
                  <div class="member-image-wrapper">
                    <a data-w-id="38a655a7-4ec8-dfc5-678f-6cdd6703ac47" style="opacity:0" href="#" class="member-image-wrap w-inline-block"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" loading="lazy" alt="" class="member-img w-dyn-bind-empty"></a>
                  </div>
                  <div class="member-contant-wrapper">
                    <div class="member-contant">
                      <div data-w-id="8fb3652c-4ef7-936f-6abb-37e913950dce" style="opacity:0" class="member-details-wrapper">
                        <a href="#" class="member-name-link w-inline-block">
                          <h3 class="member-name w-dyn-bind-empty"></h3>
                        </a>
                        <div class="member-info w-dyn-bind-empty"></div>
                        <p class="member-details w-dyn-bind-empty"></p>
                      </div>
                      <div data-w-id="976f3bd4-c900-79ba-9824-204906ed5477" style="-webkit-transform:translate3d(-50%, 0, 0) scale3d(0, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(-50%, 0, 0) scale3d(0, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(-50%, 0, 0) scale3d(0, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(-50%, 0, 0) scale3d(0, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)" class="member-divider"></div>
                      <div data-w-id="eaa423f4-60c6-4af5-e9f4-3e34e9d90a8c" style="opacity:0" class="member-social-media-wrap">
                        <a href="#" class="member-social-media-link w-inline-block">
                          <div class="member-social-icon"></div>
                        </a>
                        <a href="#" class="member-social-media-link w-inline-block">
                          <div class="member-social-icon"></div>
                        </a>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443b2" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              ...
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="author.do" aria-current="page" class="single-footer-link w-inline-block w--current">
