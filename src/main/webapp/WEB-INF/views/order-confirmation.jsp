...
<html data-wf-page="6634a93befaafa41dc30c183" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Order Confirmation | Zastock | Webflow Ecommerce Website Template</title>
...
<body>
  <div class="pages-wrapper">
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Order Confirmation</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="https://zastock.webflow.io/order-confirmation" class="single-breadcrumb-link checkout w-inline-block">
    ...
    <div data-node-type="commerce-order-confirmation-wrapper" data-wf-order-query="" data-wf-page-link-href-prefix="" class="w-commerce-commerceorderconfirmationcontainer checkout-from">
      <div class="w-commerce-commercelayoutcontainer container w-container">
        <div class="w-commerce-commercelayoutmain split-contant left">
          ...
          <div class="w-commerce-commercecheckoutshippingsummarywrapper checkout-card">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
          ...
          <div class="w-commerce-commercecheckoutorderitemswrapper checkout-card mg-bottom-0px">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e771000000000051"></script>
              <div role="list" class="w-commerce-commercecheckoutorderitemslist order-item-list" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e771000000000051"></div>
            </fieldset>
          </div>
        </div>
        <div class="w-commerce-commercelayoutsidebar split-contant right">
          <div class="w-commerce-commercecheckoutordersummarywrapper checkout-card mg-bottom-0px">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              ...
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e77100000000006b">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
              <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e77100000000006b">
