...
<html data-wf-page="6634a93befaafa41dc30c18b" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Upload A Collection | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Upload A Collection | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Upload A Collection | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="page-dropdown-list-flex-wrap">
                              <div class="dropdown-list-wrapper">
                                ...
                                <a href="upload-a-collection.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Upload A Collection</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="upload-a-collection.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Upload A Collection</div>
            </a>
          </div>
        </div>
      </div>
    </section>
    <section class="section upload-a-collection">
      <div class="container">
        <div class="upload-a-collection-wrapper">
          <div class="upload-a-collection-card">
            <div class="upload-a-collection-card-contant">
              <div class="upload-a-collection-from-block w-form">
                <form id="wf-form-Collection-Email-Form" name="wf-form-Collection-Email-Form" data-name="Collection Email Form" method="get" class="upload-a-collection-from" data-wf-page-id="6634a93befaafa41dc30c18b" data-wf-element-id="f7e8a1e6-a164-6fef-b5c0-c8a921127172">
                  <div id="w-node-_55aa22c0-8475-bc75-b496-824156fe96a7-dc30c18b" class="input-wrapper"><label for="Collection-Title" class="input-title">Title</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-Title" data-name="Collection Title" placeholder="Enter title here" type="text" id="Collection-Title" required=""></div>
                  <div id="w-node-d86a272e-f2df-cbb6-07d2-8a29e282a0b6-dc30c18b" class="input-wrapper"><label for="Collection-Resolution" class="input-title">Resolution</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-Resolution" data-name="Collection Resolution" placeholder="3840 x 2160" type="text" id="Collection-Resolution" required=""></div>
                  <div id="w-node-_5db43c8c-97ae-1c82-7494-35c584485218-dc30c18b" class="input-wrapper"><label for="Collection-Size" class="input-title">Size</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-Size" data-name="Collection Size" placeholder="9.32MB" type="text" id="Collection-Size" required=""></div>
                  <div id="w-node-_60304bf3-0c4c-6ce2-ed5c-6a5abc1c30c6-dc30c18b" class="input-wrapper"><label for="Collection-File" class="input-title">File Type</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-File" data-name="Collection File" placeholder="JPG, PNG, MP4" type="text" id="Collection-File" required=""></div>
                  <div id="w-node-_32ec88b4-4574-96c5-8d18-e7273b22fd2c-dc30c18b" class="input-wrapper"><label for="Collection-Price" class="input-title">Price</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-Price" data-name="Collection Price" placeholder="$10.20 USD " type="text" id="Collection-Price" required=""></div>
                  <div id="w-node-_3c59b79d-709c-0f32-401f-b17e6439f339-dc30c18b" class="input-wrapper"><label for="Collection-Textarea" class="input-title">Description</label><textarea placeholder="Describe the collection here..." maxlength="5000" id="Collection-Textarea" name="Collection-Textarea" data-name="Collection Textarea" class="textarea upload-a-collection w-input"></textarea></div>
                  <div id="w-node-_8f67f9e1-80a1-dd0d-3b7b-26a4b7c5d403-dc30c18b" class="collection-category-wrap">
                    <div class="input-title">Category</div>
                    <div class="collection-category-item-wrap"><label class="w-checkbox checkbox-wrapper">
                        <div class="w-checkbox-input w-checkbox-input--inputType-custom collection-checkbox"></div><input type="checkbox" id="Checkbox-Image" name="Checkbox-Image" data-name="Checkbox  Image" style="opacity:0;position:absolute;z-index:-1"><span class="collection-checkbox-name w-form-label" for="Checkbox-Image">Images</span>
                      </label><label class="w-checkbox checkbox-wrapper">
                        <div class="w-checkbox-input w-checkbox-input--inputType-custom collection-checkbox"></div><input type="checkbox" id="Checkbox-Illustration" name="Checkbox-Illustration" data-name="Checkbox Illustration" style="opacity:0;position:absolute;z-index:-1"><span class="collection-checkbox-name w-form-label" for="Checkbox-Illustration">Illustration</span>
                      </label><label class="w-checkbox checkbox-wrapper">
                        <div class="w-checkbox-input w-checkbox-input--inputType-custom collection-checkbox"></div><input type="checkbox" id="Checkbox-Video" name="Checkbox-Video" data-name="Checkbox Video" style="opacity:0;position:absolute;z-index:-1"><span class="collection-checkbox-name w-form-label" for="Checkbox-Video">Video</span>
                      </label></div>
                  </div>
                  <div id="w-node-ca2d66df-c48f-2892-f68f-1e57e7cf73aa-dc30c18b" class="input-wrapper"><label for="Collection-Link" class="input-title">Collection Link</label><input class="input upload-a-collection w-input" maxlength="256" name="Collection-Link" data-name="Collection Link" placeholder="Paste collection link " type="text" id="Collection-Link" required=""></div>
                  <div id="w-node-cf6db25d-0f31-84b8-5039-ff7eb68dd77f-dc30c18b" class="input-wrapper"><label for="Profile-Link" class="input-title">Profile Link</label><input class="input upload-a-collection w-input" maxlength="256" name="Profile-Link" data-name="Profile Link" placeholder="Paste profile link " type="text" id="Profile-Link" required=""></div>
                  <div id="w-node-e446621e-a584-da95-2f81-ab367c6ada65-dc30c18b" class="become-an-author-wrap">
                    <div class="become-an-author-details">Don’t have a profile? <a href="become-an-author.do" class="become-an-author-link">Become an author</a>
                    </div>
                  </div><input type="submit" data-wait="Please wait..." id="w-node-f7e8a1e6-a164-6fef-b5c0-c8a921127179-dc30c18b" class="submit-button primary-color-1 w-button" value="Upload Collection">
                </form>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443b2" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="upload-a-collection.do" aria-current="page" class="single-footer-link w-inline-block w--current">
