...
<body>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">자유게시판 상세보기</h2>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            	<form name="replyFrm" id="replyFrm">
                            		...
                            		<input type="hidden" name="userEmail" id="userEmail" value="${sessionScope.logEmail}" />
 ...
 <script>
    //var sessionEmail = "${sessionScope.logEmail}";
    //var postEmail = "${detailFreeBoard.userEmail}";
</script>
