                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="adminUpdateQuestionBoard" method='post'>
                                	...
                                	<table >
                                		...
                                		<tr>
                                			<td>답변 내용</td>
                                			<td><textarea cols='100' rows='7' name="asAnswer">${answerBoard.asAnswer }</textarea></td>
                                		</tr>
                                		<tr>
                                			<td colspan='2' align='right'><input type='submit' value='답변하기' /></td>
                                		</tr>
                                	</table>
                                </form>
                            </div>
