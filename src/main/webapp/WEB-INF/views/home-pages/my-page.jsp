          ...
          <div class="split-contant navbar-middle">
            <nav role="navigation" class="nav-menu-wrapper v1 w-nav-menu">
              <div class="nav-menu-links-wrapper">
                <a href="../home-pages/home-01.do" aria-current="page" class="nav-single-link natural-color-100 w-inline-block">
              <div>home</div>
                </a>
    ...
    <section data-w-id="19aa3eec-f579-20eb-f3a1-3e62676edd79" class="section v1-banner">
      <div class="container">
        <div data-w-id="19aa3eec-f579-20eb-f3a1-3e62676edd7b" style="opacity:0" class="v1-banner-top-wrapper">
          <h1 class="banner-title natural-color-100">My Gallery</h1>
<%--           <div class="banner-search-wrapper">
            <form action="/searchPic" method="post" class="banner-search w-form"><input class="search v1-banner w-input" maxlength="256" name="query" placeholder="관심있는 사진을 찾아보세요:)" type="text" id="search" required=""><input type="submit" class="search-button w-button" value="검색하기"></form>
          </div>
        </div>
      </div>
    ...
    <div class="v1-banner-absolate-wrap">
        <div class="v1-banner-ticker-image-wrap _01">
            <div class="v1-banner-ticker">
                <div class="v1-ticker-item-wrap">
                    <img src="${pageContext.request.contextPath}/resources/images/banner-ticker-item-1.png" loading="lazy" alt="" class="v1-banner-ticker-img">
                    <img src="${pageContext.request.contextPath}/resources/images/banner-ticker-item-2.png" loading="lazy" alt="" class="v1-banner-ticker-img">
                </div>
                <div class="v1-ticker-item-wrap">
                    <img src="${pageContext.request.contextPath}/resources/images/banner-ticker-item-1.png" loading="lazy" alt="" class="v1-banner-ticker-img">
                    <img src="${pageContext.request.contextPath}/resources/images/banner-ticker-item-2.png" loading="lazy" alt="" class="v1-banner-ticker-img">
                ...
                <c:forEach var="image" items="${userImages}">
                    <div class="v1-ticker-item-wrap">
                        <img src="${pageContext.request.contextPath}/resources/upload/${image.picEmail}/${image.picId}" 
                             loading="lazy" alt="" class="v1-banner-ticker-img">
                    </div>
                </c:forEach>
                <!-- End of merge -->
            </div>
