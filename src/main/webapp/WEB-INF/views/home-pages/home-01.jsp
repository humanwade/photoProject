      ...
      <div class="container">
        <div class="navbar-wrapper">
		  ...
		  <div data-hover="true" data-delay="0" class="nav-dropdown pages w-dropdown">
			<div class="single-nav-link pages-toggle natural-color-100 w-dropdown-toggle">
				<div>
				  <img id="personIcon" src="${pageContext.request.contextPath}/resources/images/personIcon.png" style="height: 30px; width: 33px;">&nbsp;&nbsp;<%=logEmail%>님
				</div>
					  ...
					  <div class="home-dropdown-links-wrap-2">
						<div class="page-dropdown-list-wrap">
						  <div class="dropdown-grid-2">
							<div class="pages-dropdown-single-links-wrap">
							  <a href="follow.jsp" aria-current="page" class="dropdown-nav-link w-inline-block w--current" style="display: block;">
								<div>Following Artists</div>
								  </a> <a href="myGallery.jsp" class="dropdown-nav-link w-inline-block" style="display: block;">
								<div>My Gallery</div>
								  </a> <a href="home-01.do" class="dropdown-nav-link w-inline-block" style="display: block;">
								<div>Log Out</div>
							  </a>
							</div>
						  </div>
                    ...
                    <div data-w-tab="Tab 1" class="banner-image-tab-pane w-tab-pane w--tab-active">
					   <div class="v1-banner-image-grid">
					       <div id="w-node-_9719f9d1-62d6-c840-1630-d346f158e9ec-dc30c16c" class="banner-image-flex-wrap">
					          <table> <!-- 1테이블 시작 -->
					          <caption>인물사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					       			<c:if test="${image.photoType == '인물사진'}">
					       			...
					       			<td class="banner-image-single-wrapper">
					           			<div class="banner-image-wrapper">
					                   		...
					                   		<img class="banner-img" src="${pageContext.request.contextPath}/photoImage/${image.picEmail}/${image.picId}" alt="이미지">
					               			</div>
					               			<div class="banner-image-overlay-wrap">
					               				<div class="banner-image-author-contant">
					               					...
					               					<div class="circle-button-wrap">
					               						...
					               						<img loading="lazy" src="../resources/images/circle-button-icon.svg" alt="" class="circle-button-icon"></a>
					               					</div>
					      ...
					      <div class="w-layout-grid banner-image-2-columns-grid" >
					      	<div id="w-node-_97bb8fac-3c94-cb35-626c-794cfa42993a-dc30c16c" class="banner-image-flex-wrap">
           			 		  <table> <!-- 2-1테이블 시작 -->
           			 		  	<caption>풍경사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					       			<c:if test="${image.photoType == '풍경사진'}">
					       			<c:if test="${loop.index % 1 == 0}">
					           		<tr></tr> 
					       			</c:if>
					       			<td class="banner-image-single-wrapper">
						     ...
						     <div id="w-node-_97bb8fac-3c94-cb35-626c-794cfa429977-dc30c16c" class="banner-image-flex-wrap">
           			 		  <table> <!-- 2-2테이블 시작 -->
           			 		   <caption>반려동물사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					   				<c:if test="${image.photoType == '반려동물사진'}">
					       			<c:if test="${loop.index % 1 == 0}">
					           		<tr></tr> 
					       			</c:if>
					       			<td class="banner-image-single-wrapper">
						   ...
						   <div id="w-node-_97bb8fac-3c94-cb35-626c-794cfa4299b4-dc30c16c" class="banner-image-flex-wrap">
					          <table> <!-- 3테이블 시작 -->
					           <caption>여행사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					   				<c:if test="${image.photoType == '여행사진'}">
					       ...
					       <div id="w-node-_97bb8fac-3c94-cb35-626c-794cfa429a05-dc30c16c" class="banner-image-flex-wrap">
					          <table> <!-- 4테이블 시작 -->
					            <caption>음식사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					   				<c:if test="${image.photoType == '음식사진'}">
					       			<c:if test="${loop.index % 1 == 0}">
					           		<tr></tr> 
					       			</c:if>
					       			<td class="banner-image-single-wrapper">
                    ...
                    <div data-w-tab="Tab 1" class="banner-image-tab-pane w-tab-pane w--tab-active">
                      ...
                      <div class="v1-banner-image-grid">
					       <div id="w-node-_910d842a-41d8-dca4-d59b-bb6cdf08bbae-dc30c16c" class="banner-image-flex-wrap">
					          <table> <!-- 1테이블 시작 -->
					          <caption class="split-contant navbar-middle">인물사진</caption>
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					   			<c:if test="${image.photoType == '인물사진'}">
					       			<c:if test="${loop.index % 1 == 0}">
					           		<tr></tr> 
