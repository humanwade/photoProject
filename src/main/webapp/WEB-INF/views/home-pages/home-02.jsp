      ...
      <div class="container">
        <div class="navbar-wrapper">
		  ...
		  <div data-hover="true" data-delay="0" class="nav-dropdown pages w-dropdown">
			<div class="single-nav-link pages-toggle natural-color-100 w-dropdown-toggle">
				<div>
				  <img id="personIcon" src="${pageContext.request.contextPath}/resources/images/personIcon.png" style="height: 30px; width: 33px;"><%=logEmail%>님 로그인했습니다.
				</div>
					  ...
					  <div class="home-dropdown-links-wrap-2">
						<div class="page-dropdown-list-wrap">
						  <div class="dropdown-grid-2">
							<div class="pages-dropdown-single-links-wrap">
							  <a href="${pageContext.request.contextPath}/home-pages/my-page.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current" style="display: block;">
								<div>My Page</div>
								  </a> <a href="${pageContext.request.contextPath}/photoInsertBoard.do" class="dropdown-nav-link w-inline-block" style="display: block;">
								<div>Upload</div>
								  </a> <a href="${pageContext.request.contextPath}/home-pages/home-01.do" class="dropdown-nav-link w-inline-block" style="display: block;">
								<div>Log Out</div>
							  </a>
							</div>
						  </div>
					   			...
					   			<c:forEach items="${photoList}" var="image" varStatus="loop">
					       			...
					       			<td class="banner-image-single-wrapper">
					           			<div class="banner-image-wrapper">
					                   		...
					                   		<img class="banner-img" src="${pageContext.request.contextPath}/resources/upload/${image.picEmail}/${image.picId}" alt="이미지">
					               			</div>
					           			</div>
					       			</td>
					   			</c:forEach>
