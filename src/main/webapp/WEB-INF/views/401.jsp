...
<html data-wf-page="6634a93befaafa41dc30c12b" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Password | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Password | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Password | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
                        ...
                        <div class="pages-dropdown-flex">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="dropdown-list-wrapper">
                              ...
                              <a href="401.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Protected Password</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="401.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Protected Password</div>
            </a>
          </div>
        </div>
      </div>
    </section>
    <div class="section protected-password w-password-page w-form">
      <form action="/.wf_auth" method="post" id="wf-form-Password-Email-Form" name="wf-form-Password-Email-Form" data-name="Password Email Form" class="container w-password-page" data-wf-page-id="6634a93befaafa41dc30c12b" data-wf-element-id="65d34def78713e4ba2dff8a900000000000c">
        <div class="protected-password-wrapper">
          <div class="protected-password-card">
            <div data-w-id="cb08c921-6362-a7e4-2ec3-04466a1b94c4" style="opacity:0" class="protected-password-card-contant">
              <div class="protected-password-icon-wrap"><img alt="" src="images/protected-password-icon.svg" class="protected-password-icon"></div>
              <h3 class="protected-password-title">Protected Password</h3>
              <p class="protected-password-details">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla mollis est id faucibus iaculis. Cras et congue tortor.</p><label for="pass" class="password-input-title w-password-page">Enter Password</label>
              <div class="password-input-button-wrap"><input class="input password w-password-page w-input" maxlength="256" name="pass" data-name="field" placeholder="Enter your password" type="password" id="pass"><input type="submit" data-wait="Please wait..." class="submit-button primary-color-1 w-password-page w-button" value="Continue"></div>
            </div>
          </div>
        </div>
        ...
        <div class="cta-wrapper">
          <div class="cta-card inner">
            <div class="cta-card-contant center">
              <h3 class="cta-title natural-color-800">Subscribe To Our Newsletter</h3>
              <p class="cta-details natural-color-500">Subscribe to our newsletter and stay informed with the latest updates, exclusive offers, and insightful content delivered straight to your inbox. Don&#x27;t miss out – join our community today and be the first to know!&quot;</p>
              <div class="cta-from-wrap">
                <div class="cta-from-block w-form">
                  <form id="wf-form-Cta-Email-From" name="wf-form-Cta-Email-From" data-name="Cta Email From" method="get" class="cta-from" data-wf-page-id="6634a93befaafa41dc30c12b" data-wf-element-id="67e220df-7a68-6e9a-1cab-afc2c396541c"><input class="input cta inner w-input" maxlength="256" name="Cta-Email-2" data-name="Cta Email 2" placeholder="Enter your email address" type="email" id="Cta-Email-2" required=""><input type="submit" data-wait="Please wait..." class="submit-button primary-color-1 w-button" value="Browse All Articles"></form>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443d9" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="401.do" aria-current="page" class="single-footer-link w-inline-block w--current">
