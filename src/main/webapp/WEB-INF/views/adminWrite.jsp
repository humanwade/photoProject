                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="saveBoard" method='post'>
                                   <input type="hidden" name="managerNumber" value="${sessionScope.adminLoginNumber}" />
                                	 <table >
                                		<tr>
                                			<td>관리자 아이디 :</td>
                                		...
                                		<tr>
                                			<td>공지사항 제목</td>
                                			<td><input type='text' name="anTitle" style="width: 70%;"/></td>
                                		</tr>
                                		<tr>
                                			<td>내용</td>
                                			<td><textarea cols='100' rows='15' name="anContent" ></textarea></td>
                                		</tr>
                                		<tr>
                                			<td colspan='2' align='right'><input type='submit' value='공지 등록' /></td>
                                		</tr>
                                	</table>
                                </form>
                            </div>
