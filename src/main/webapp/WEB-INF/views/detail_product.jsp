...
<html data-wf-page="6634a93befaafa41dc30c168" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>| Zastock | Webflow Ecommerce Website Template</title>
...
<body>
  <div class="pages-wrapper">
      ...
      <div class="container">
        <div class="navbar-wrapper">
          <div class="split-contant navbar-left">
            <a href="index.html" class="navbar-logo-wrap w-nav-brand"><img src="${pageContext.request.contextPath}/resources/images/navbar-icon.svg" loading="lazy" alt="" class="navbar-logo"></a>
          </div>
      ...
      <div class="container">
        <div class="inner-banner-wrapper">
          ...
          <div class="breadcrumb-wrapper">
            ...
            <a href="product.html" class="single-breadcrumb-link w-inline-block">
              <div>Products</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
    ...
    <section class="section products-single">
      <div class="container">
        <div class="single-products-contant-wrap">
          <div class="w-layout-grid products-single-grid">
            <div id="w-node-_314e4c08-6699-c54e-6d76-b755c92028d5-dc30c168" data-w-id="314e4c08-6699-c54e-6d76-b755c92028d5" style="opacity:0" class="products-single-image-wrapper"><img alt="" loading="lazy" src="" class="products-single-img"></div>
            <div id="w-node-d4dc09c6-7505-1a7c-084f-4bc5f31c35be-dc30c168" data-w-id="d4dc09c6-7505-1a7c-084f-4bc5f31c35be" style="opacity:0" class="products-single-contant-wrapper">
              <div class="products-single-card">
                <div class="products-card-contant">
                  <div class="products-single-info-wrap">
                    <div class="products-single-img-name-flex"><img alt="" loading="lazy" src="" class="products-single-suthor-img">
                      <h3 class="products-single-author-name"></h3>
                    </div>
                  </div>
                  <div class="products-single-info-wrap">
                    <div class="products-single-info-flex">
                      <h3 class="products-single-info-title">Category :</h3>
                      <h3 class="products-single-info"></h3>
                    </div>
                  </div>
                  <div class="products-single-info-wrap">
                    <div class="products-single-info-flex">
                      <h3 class="products-single-info-title">Resolution :</h3>
                      <h3 class="products-single-info"></h3>
                    </div>
                  </div>
                  <div class="products-single-info-wrap">
                    <div class="products-single-info-flex">
                      <h3 class="products-single-info-title">Size :</h3>
                      <h3 class="products-single-info"></h3>
                    </div>
                  </div>
                  <div class="products-single-info-wrap">
                    <div class="products-single-info-flex">
                      <h3 class="products-single-info-title">Type :</h3>
                      <h3 class="products-single-info"></h3>
                    </div>
                  </div>
                  <div class="products-single-info-wrap">
                    <div class="products-single-info-flex">
                      <h3 class="products-single-info-title">Downloads :</h3>
                      <h3 class="products-single-info"></h3>
                    </div>
                  </div>
                  <div class="products-single-contant-wrap">
                    <div class="cart-price-wrap">
                      <h3 class="cart-price"></h3>
                    </div>
                    <div>
                      <form data-node-type="commerce-add-to-cart-form" class="w-commerce-commerceaddtocartform mg-bottom-0px">
                        <div class="cart-details-wrap">
                          <p class="cart-details"></p>
                        </div><label for="quantity-44136247e33e3bea35c244e9350b6067" class="cart-quantity">Quantity</label><input type="submit" data-node-type="commerce-add-to-cart-button" data-loading-text="" aria-busy="false" aria-haspopup="dialog" class="w-commerce-commerceaddtocartbutton add-to-cart-button" value="Add To Cart">
      ...
      <div class="container">
        <div class="footer-top">
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443a0" class="footer-details-wrap">
            <a href="index.html" class="footer-logo-wrap w-inline-block"><img src="${pageContext.request.contextPath}/resources/images/footer-logo.svg" loading="lazy" alt="" class="footer-logo"></a>
