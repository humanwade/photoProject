...
<html data-wf-page="6634a93befaafa41dc30c187" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Search Results | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Search Results | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Search Results | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  <div class="pages-wrapper">
    ...
    <section class="section search-result">
      <div class="container">
        <div data-w-id="6c556b8d-31b0-9315-21de-5635c695bda7" style="opacity:0" class="search-wrapper">
          <form action="/search" class="products-search w-form"><input class="search products w-input" maxlength="256" name="query" placeholder="Search…" type="search" id="search" required=""><input type="submit" class="search-button products w-button" value="Search"></form>
        </div>
      </div>
    </section>
