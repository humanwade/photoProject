    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">1:1 문의사항 글쓰기</h2>
                            ...
                            <div class="card-body">
                                <form action="questionSaveBoard.do" method='post'>
                                	...
                                	<table >
                                		...
                                		<tr>
                                			<td>제목</td>
                                			<td><input type='text' name="asTitle" style="width: 70%;"/></td>
                                		</tr>
                                		<tr>
                                			<td>내용</td>
                                			<td><textarea class=freeContent cols='100' rows='15' name="asContent" ></textarea></td>
                                		</tr>
                                		<tr>
                                			<td colspan='2' align='right'><input type='submit' value='문의 등록' /></td>
                                		</tr>
                                	</table>
                                </form>
                            </div>
