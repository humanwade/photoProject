...
<html data-wf-page="6634a93befaafa41dc30c185" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Product | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Product | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Product | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  ...
  <div style="opacity:0" class="pages-wrapper">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="page-dropdown-list-flex-wrap">
                              ...
                              <div class="dropdown-list-wrapper">
                                ...
                                <a href="product.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                  <div>Products</div>
                                </a>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper mg-bottom-28px">
          <h2 class="inner-banner-title">All Products</h2>
        </div>
        <div data-w-id="20838e7d-d79f-bf9e-f8a9-b67af926a75d" style="opacity:0" class="products-search-wrapper">
          <form action="/search" class="products-search w-form"><input class="search products w-input" maxlength="256" name="query" placeholder="Search our curated collection" type="search" id="search" required=""><input type="submit" class="search-button products w-button" value="Browse Collections"></form>
        </div>
      </div>
    </section>
    <section class="section products">
      <div data-w-id="0d88e427-a92d-fbc0-d8ca-f494a26229fc" style="opacity:0" class="products-contant-wrapper">
        <div class="product-categories-wrap">
          <div class="w-dyn-list">
            <div role="list" class="product-categories-flex-wrap w-dyn-items">
              <div role="listitem" class="product-categories-flex-wrap w-dyn-item">
                <a href="product.do" aria-current="page" class="product-categories-link w-inline-block w--current">
                  <div>All</div>
                </a>
                <a href="#" class="product-categories-link w-inline-block">
        ...
        <div class="product-collection-wrapper">
          <div class="products-categories-wrap">
            <div class="w-dyn-list">
              <div role="list" class="products-categories-flex-wrap w-dyn-items">
                <div role="listitem" class="products-categories-flex-wrap collection-item w-dyn-item">
                  <a href="product.do" aria-current="page" class="products-categories-link w-inline-block w--current">
                    <div>All</div>
                  </a>
                  <a href="#" class="products-categories-link w-inline-block">
                    <div></div>
                  </a>
                </div>
              </div>
          ...
          <div class="container">
            <div class="products-collectiob-list-wrapper w-dyn-list">
              <div role="list" class="products-collection-list-wrap w-dyn-items">
                <div role="listitem" class="w-dyn-item">
                  <div class="products-single-wrapper products">
                    <div class="products-image-wrapper">
                      <a href="#" class="products-image-link w-inline-block"><img loading="lazy" src="" alt="" class="products-img"></a>
                      <div class="products-overlay-wrapper">
                        <div class="products-overlay-contant">
                          <div class="circle-button-wrap">
                            <a href="#" class="circle-button w-inline-block"><img loading="lazy" src="" alt="" class="circle-button-icon"></a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="products-contant-wrapper">
                      <div class="products-flex-wrapper">
                        <div class="products-author-wrap">
                          <div class="products-author-img-wrap"><img loading="lazy" src="" alt="" class="products-author-img"></div>
                          <div class="products-author-name-wrap">
                            <a href="#" class="products-author-name-link w-inline-block">
                              <h3 class="products-author-name"></h3>
                            </a>
                            <div class="products-author-date"></div>
                          </div>
                        </div>
                        <div class="products-price-cart-wrap">
                          <div class="products-price-wrap">
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443b2" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              ...
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="product.do" aria-current="page" class="single-footer-link w-inline-block w--current">
