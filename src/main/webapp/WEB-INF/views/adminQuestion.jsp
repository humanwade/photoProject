                                    ...
                                    <tbody>
                                        <c:forEach items="${questionBoardList }" var="questionBoard">
                                       	<tr>
                                       		...
                                       		<td>${questionBoard.asTitle }</td>
                                       		<td>${questionBoard.userEmail }</td>
                                       		<td><fmt:formatDate value="${questionBoard.asCreateDate }" pattern="yyyy-MM-dd" /></td>
                                       		<td align="center"><a href="adminAnswerBoard?asId=${questionBoard.asId }">답변</a></td>
                                       		<td align="center"><a href='adminDeleteQuestionBoard?asId=${questionBoard.asId }'>삭제</a></td>
                                       	</tr>
                                       </c:forEach>
                                    </tbody>
                                </table>
