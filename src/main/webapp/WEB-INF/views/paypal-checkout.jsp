...
<html data-wf-page="6634a93befaafa41dc30c184" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <base target="_parent">
  <title>Checkout (Paypal) | Zastock | Webflow Ecommerce Website Template</title>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Checkout With (Paypal)</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="https://zastock.webflow.io/paypal-checkout" class="single-breadcrumb-link checkout w-inline-block">
              <div>Checkout (Paypal)</div>
            </a>
          </div>
        </div>
      </div>
    </section>
    <div data-node-type="commerce-paypal-checkout-form-container" data-wf-checkout-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercepaypalcheckoutformcontainer checkout-from">
      <div class="w-commerce-commercelayoutcontainer container w-container">
        <div class="w-commerce-commercelayoutmain split-contant left">
          ...
          <div class="w-commerce-commercecheckoutcustomerinfosummarywrapper checkout-card">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
              <h2 class="title checkout">Customer Information</h2>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              <div class="w-commerce-commercecheckoutrow">
                <div class="w-commerce-commercecheckoutcolumn">
                  <div class="w-commerce-commercecheckoutsummaryitem"><label class="w-commerce-commercecheckoutsummarylabel checkout-field-label">Email</label>
                    <div class="checkout-required-text"></div>
                  </div>
                </div>
                <div class="w-commerce-commercecheckoutcolumn">
                  <div class="w-commerce-commercecheckoutsummaryitem"><label class="w-commerce-commercecheckoutsummarylabel checkout-field-label">Shipping Address</label>
                    <div class="checkout-required-text"></div>
                    <div class="checkout-required-text"></div>
                    <div class="checkout-required-text"></div>
                    <div class="w-commerce-commercecheckoutsummaryflexboxdiv">
                      <div class="w-commerce-commercecheckoutsummarytextspacingondiv checkout-required-text"></div>
                      <div class="w-commerce-commercecheckoutsummarytextspacingondiv checkout-required-text"></div>
                      <div class="w-commerce-commercecheckoutsummarytextspacingondiv checkout-required-text"></div>
                    </div>
                    <div class="checkout-required-text"></div>
          ...
          <div class="w-commerce-commercecheckoutpaymentsummarywrapper checkout-card">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              <div class="w-commerce-commercecheckoutrow">
                <div class="w-commerce-commercecheckoutcolumn">
                  <div class="w-commerce-commercecheckoutsummaryitem"><label class="w-commerce-commercecheckoutsummarylabel checkout-field-label">Payment Info</label>
                    <div class="w-commerce-commercecheckoutsummaryflexboxdiv">
                      <div class="w-commerce-commercecheckoutsummarytextspacingondiv checkout-required-text"></div>
                ...
                <div class="w-commerce-commercecheckoutcolumn">
                  <div class="w-commerce-commercecheckoutsummaryitem"><label class="w-commerce-commercecheckoutsummarylabel checkout-field-label">Billing Address</label>
                    <div class="checkout-required-text"></div>
                    <div class="checkout-required-text"></div>
                    <div class="checkout-required-text"></div>
                    <div class="w-commerce-commercecheckoutsummaryflexboxdiv">
          ...
          <div class="w-commerce-commercecheckoutorderitemswrapper checkout-card mg-bottom-0px">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e763000000000056"></script>
              <div role="list" class="w-commerce-commercecheckoutorderitemslist order-item-list" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e763000000000056"></div>
            </fieldset>
          </div>
        </div>
        <div class="w-commerce-commercelayoutsidebar split-contant right">
          <div class="w-commerce-commercecheckoutordersummarywrapper checkout-card">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              ...
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e763000000000070">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
              <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e763000000000070">
          ...
          <a href="#" value="Place Order" data-node-type="commerce-checkout-place-order-button" class="w-commerce-commercecheckoutplaceorderbutton submit-button primary-color-1 checkout" data-loading-text="Placing Order...">Place Order</a>
