...
<html data-wf-page="6634a93befaafa41dc30c14d" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Become An Author | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Become An Author | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Become An Author | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
      ...
      <div class="container">
        <div class="navbar-wrapper">
          ...
          <div class="split-contant navbar-middle">
            <nav role="navigation" class="nav-menu-wrapper w-nav-menu">
              <div class="nav-menu-links-wrapper">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="page-dropdown-list-flex-wrap">
                              <div class="dropdown-list-wrapper">
                                ...
                                <a href="become-an-author.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                ...
                <a href="become-an-author.do" aria-current="page" class="inner-button mobile w-inline-block w--current">
                  <div>Become An Author</div>
          ...
          <div class="split-contant navbar-right">
              ...
              <div style="display:none" class="w-commerce-commercecartcontainerwrapper w-commerce-commercecartcontainerwrapper--cartType-leftSidebar cart-wrapper" data-node-type="commerce-cart-container-wrapper">
                <div data-node-type="commerce-cart-container" role="dialog" class="w-commerce-commercecartcontainer cart-container">
                  <div class="w-commerce-commercecartheader cart-header">
                    ...
                    <a class="w-commerce-commercecartcloselink cart-close-button w-inline-block" role="button" aria-label="Close cart" data-node-type="commerce-cart-close-link"><img src="${pageContext.request.contextPath}/resources/imagess/cart-close-icon.svg" loading="lazy" alt="" class="cart-close-icon"></a>
                  </div>
            ...
            <a href="become-an-author.do" aria-current="page" class="inner-button desktop w-inline-block w--current">
              <div>Become An Author</div>
              <div class="inner-button-bg"></div>
            </a>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Become An Author</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="become-an-author.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Become An Author</div>
            </a>
          </div>
        </div>
          ...
          <div class="upload-a-collection-card">
            <div class="upload-a-collection-card-contant">
              <div class="upload-a-collection-from-block w-form">
                <form id="wf-form-Author-Email-Form" name="wf-form-Author-Email-Form" data-name="Author Email Form" method="get" class="upload-a-collection-from" data-wf-page-id="6634a93befaafa41dc30c14d" data-wf-element-id="d9170c1c-2746-1a11-1723-6871879e17b6">
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17bb-dc30c14d" class="input-wrapper"><label for="Author-Full-Name" class="input-title">Full Name</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Full-Name" data-name="Author Full Name" placeholder="Alex Anderson" type="text" id="Author-Full-Name" required=""></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17bf-dc30c14d" class="input-wrapper"><label for="Author-Email" class="input-title">Email Address</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Email" data-name="Author Email" placeholder="alexanderson@gmail.com" type="email" id="Author-Email" required=""></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17c3-dc30c14d" class="input-wrapper"><label for="Author-Phone-Number" class="input-title">Phone Number</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Phone-Number" data-name="Author Phone Number" placeholder="(+880) 25632 142655" type="tel" id="Author-Phone-Number" required=""></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17c7-dc30c14d" class="input-wrapper"><label for="Author-Location" class="input-title">Location</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Location" data-name="Author Location" placeholder="San Francisco, California" type="text" id="Author-Location" required=""></div>
                  <div id="w-node-a6bb2a78-ccc9-62a4-41b2-af853e21b0b5-dc30c14d" class="input-wrapper"><label for="Author-Website" class="input-title">Website</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Website" data-name="Author Website" placeholder="www.alexanderson.com" type="text" id="Author-Website" required=""></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17cb-dc30c14d" class="input-wrapper"><label for="Author-Textarea" class="input-title">Description</label><textarea id="Author-Textarea" name="Author-Textarea" maxlength="5000" data-name="Author Textarea" placeholder="Describe the collection here..." class="textarea upload-a-collection w-input"></textarea></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17df-dc30c14d" class="input-wrapper"><label for="Author-Facebook-Link" class="input-title">Facebook</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Facebook-Link" data-name="Author Facebook Link" placeholder="facebook.com/@username" type="text" id="Author-Facebook-Link" required=""></div>
                  <div id="w-node-d9170c1c-2746-1a11-1723-6871879e17e3-dc30c14d" class="input-wrapper"><label for="Author-Twiter-Link" class="input-title">Twitter</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Twiter-Link" data-name="Author Twiter Link" placeholder="twitter.com/@username" type="text" id="Author-Twiter-Link" required=""></div>
                  <div id="w-node-eba0615e-02e8-7e19-feae-dbff94c5ceef-dc30c14d" class="input-wrapper"><label for="Author-Instragram-Link" class="input-title">Profile Link</label><input class="input upload-a-collection w-input" maxlength="256" name="Author-Instragram-Link" data-name="Author Instragram Link" placeholder="instagram.com/@username" type="text" id="Author-Instragram-Link" required=""></div><input type="submit" data-wait="Please wait..." id="w-node-d9170c1c-2746-1a11-1723-6871879e17ec-dc30c14d" class="submit-button primary-color-1 w-button" value="Apply Now">
                </form>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443b2" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="become-an-author.do" aria-current="page" class="single-footer-link w-inline-block w--current">
