...
<head>
  <meta charset="utf-8">
  <title>Blog | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Blog | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Blog | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
  ...
  <div style="opacity:0" class="pages-wrapper">
	...
	<section class="section inner-banner">
        ...
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">사진수정 하기</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="question.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>사진수정 하기</div>
            </a>
          </div>
        </div>
...
<main>
                   <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
							...
							<div class="card-body">
								<form id="myForm" action="photoUpdateBoard.do" method="post">
                                <input name="PicNum" type="hidden" value="${photo.picNum}" />
                                <table>
                                <thead>
						            <tr>
						               <td>제목</td>
						               <td><input type='text' name='picTitle' value="${photo.picTitle}"/></td>
						            </tr>
						            <tr>
						               <td>작성자</td>
						            ...
						            <tr>
						               ...
						               <c:if test="${ photo.picId != null }" >
						                  <img src="${pageContext.request.contextPath}/photoImage/${photo.picEmail}/${photo.picId}" alt="${photo.picFname}" />
						               </c:if>
						         	...
						         	<div class="btnBox">
                                        	<a href="photoUpdateBoard.do" class="boardBtn" 
											onclick="document.getElementById('myForm').submit();">
                                        	사진수정</a>
                                    </div>
                                    <div class="btnBox">
                                        	<a href="photoDeleteBoard.do?PicNum=${photo.picNum}" class="boardBtn"
                                        	onclick="document.getElementById('myForm').submit();">
                                        	사진삭제</a>
                                    </div>
                                    <div class="btnBox">
