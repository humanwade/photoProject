...
<html data-wf-page="6634a93befaafa41dc30c18a" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Style Guide | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Style Guide | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Style Guide | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  ...
  <div style="opacity:0" class="pages-wrapper">
                        ...
                        <div class="pages-dropdown-flex">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="dropdown-list-wrapper">
                              ...
                              <a href="utility-pages/style-guide.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                <div>Style Guide</div>
                              </a>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Style Guide</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="utility-pages/style-guide.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Style Guide</div>
            </a>
          </div>
        </div>
    ...
    <section class="section style-guide">
      <div class="container">
        <div class="style-guide-wrapper">
          <div class="style-guide-single-wrapper">
            <div class="style-guide-mini-title">Text Style</div>
            <div class="style-guide-heading-wrapper">
              <h1 class="style-guide-heading">Heading</h1>
              <h2 class="style-guide-heading">Heading</h2>
              <h3 class="style-guide-heading">Heading</h3>
              <h4 class="style-guide-heading">Heading</h4>
              <h5 class="style-guide-heading">Heading</h5>
              <h6 class="style-guide-heading">Heading</h6>
            </div>
          </div>
          <div class="style-guide-single-wrapper">
            <div class="style-guide-mini-title">Paragraph</div>
            <div class="style-guide-paragraph-wrapper">
              <div class="single-style-paragraph-wrap">
                <h3 class="style-paragraph-title">Regular Paragraph</h3>
                <p class="style-paragraph-details">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla mollis est id faucibus iaculis. Cras et congue tortor. Integer laoreet leo risus, accumsan aliquam nisi ornare at. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                <div class="style-paragraph-info">Paragraph - Satoshi | 20px font-size / 28px line-height / Regular</div>
              </div>
              <div class="single-style-paragraph-wrap mg-bottom-0px">
                <h3 class="style-paragraph-title">Small Paragraph</h3>
                <p class="style-paragraph-details">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla mollis est id faucibus iaculis. Cras et congue tortor. Integer laoreet leo risus, accumsan aliquam nisi ornare at. when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                <div class="style-paragraph-info">Paragraph - Satoshi | 18 px font-size / 28px line-height / Regular</div>
              </div>
            </div>
          </div>
          <div class="style-guide-single-wrapper">
            <div class="style-guide-mini-title">Button</div>
            <div class="style-guide-button-wrap">
              <a href="#" class="become-an-author-button w-inline-block">
                <div>Become An Author</div>
                <div class="become-an-author-button-bg"></div>
              </a>
              <a href="#" class="inner-button w-inline-block">
                <div>Become An Author</div>
                <div class="inner-button-bg"></div>
              </a>
              <a href="#" class="contact-button w-inline-block">
                <div>Become An Author</div>
                <div class="contact-hover-bg"></div>
              </a>
            </div>
          </div>
          <div class="style-guide-single-wrapper mg-bottom-0px">
            <div class="style-guide-mini-title">Color</div>
            <div class="style-color-wrapper">
              <div class="style-color-card">
                <div class="style-color-card-contant">
                  <div class="w-layout-grid style-color-grid">
                    <div class="single-color-plate-wrap">
                      <div class="style-color-code-wrap">
                        <h3 class="style-color-code">00D084</h3>
                      </div>
                    </div>
                    <div class="single-color-plate-wrap _2">
                      <div class="style-color-code-wrap">
                        <h3 class="style-color-code">0A0A0A</h3>
                      </div>
                    </div>
                    <div class="single-color-plate-wrap _3">
                      <div class="style-color-code-wrap">
                        <h3 class="style-color-code natural-color-800">FBFDF6</h3>
                      </div>
                    </div>
                    <div class="single-color-plate-wrap _4">
                      <div class="style-color-code-wrap">
                        <h3 class="style-color-code">0F0F0F</h3>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="section cta natural-color-700">
      <div class="container">
        <div class="cta-wrapper">
          <div class="cta-card inner">
            <div class="cta-card-contant center">
              <h3 data-w-id="9085bc27-d580-65ce-0eb1-5814dfaacaf0" style="opacity:0" class="cta-title natural-color-800">Subscribe To Our Newsletter</h3>
              <p data-w-id="9085bc27-d580-65ce-0eb1-5814dfaacaf2" style="opacity:0" class="cta-details natural-color-500">Subscribe to our newsletter and stay informed with the latest updates, exclusive offers, and insightful content delivered straight to your inbox. Don&#x27;t miss out – join our community today and be the first to know!&quot;</p>
              <div data-w-id="9085bc27-d580-65ce-0eb1-5814dfaacaf4" style="opacity:0" class="cta-from-wrap">
                <div class="cta-from-block w-form">
                  <form id="wf-form-Cta-Email-From" name="wf-form-Cta-Email-From" data-name="Cta Email From" method="get" class="cta-from" data-wf-page-id="6634a93befaafa41dc30c18a" data-wf-element-id="9085bc27-d580-65ce-0eb1-5814dfaacaf6"><input class="input cta inner w-input" maxlength="256" name="Cta-Email-2" data-name="Cta Email 2" placeholder="Enter your email address" type="email" id="Cta-Email-2" required=""><input type="submit" data-wait="Please wait..." class="submit-button primary-color-1 w-button" value="Browse All Articles"></form>
      ...
      <div class="container">
        <div class="footer-top">
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443d9" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                <a href="utility-pages/style-guide.do" aria-current="page" class="single-footer-link w-inline-block w--current">
