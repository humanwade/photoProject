...
<html data-wf-page="6634a93befaafa41dc30c16f" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>License | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="License | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="License | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  ...
  <div style="opacity:0" class="pages-wrapper">
    ...
    <section class="section license">
      <div class="container">
        <div class="license-contant-wrapper">
          <div class="license-single-wrapper">
            <div class="license-title-wrapper">
              <h3 class="license-title">Images</h3>
              <p class="license-details">All graphical assets in this template are licensed for personal and commercial use. If you&#x27;d like to use a specific asset, please check the license below and download the images for free from <a href="https://unsplash.com/" target="_blank" class="license-source-link">Unsplash</a>
              </p>
            </div>
            <div data-w-id="c710eb2c-71a9-360a-9173-1f4cf737b101" style="opacity:0" class="license-image-wrapper">
              <div class="w-layout-grid license-image-grid">
                <div id="w-node-_00afb032-e8b5-c2ca-919e-7f7fda73bc12-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-1.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_4bb24aee-e1a5-05ef-c326-23bc37992e3b-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-2.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_5c03696a-dc97-4d30-dbd4-ae1dd0b01e6f-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-3.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_99cd22ca-885a-e79c-2d69-54f312823af3-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-4.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_7f08d86a-cd3e-720a-c582-af0e3bfe7fe5-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-5.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_31caa301-8104-937a-b3f9-b892da3457ed-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-6.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_695cd176-3b4d-4341-d17f-2d4f3c6cdeb1-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-7.png" loading="lazy" alt="" class="license-img"></div>
                <div id="w-node-_33b6ecf5-707f-6ed4-d799-d0babf5a9685-dc30c16f" class="license-image-wrap"><img src="${pageContext.request.contextPath}/resources/images/license-img-8.png" loading="lazy" alt="" class="license-img"></div>
              </div>
            </div>
          </div>
          <div class="license-single-wrapper mg-bottom-0px">
            <div class="license-title-wrapper mg-bottom-0px">
              <h3 class="license-title">Typography</h3>
              <p class="license-details">Typography we used in this template is <a href="https://www.fontshare.com/fonts/satoshi" target="_blank" class="license-source-link">Satoshi</a> &amp; <a href="https://www.fontshare.com/fonts/panchang" target="_blank" class="license-source-link">Panchang</a> licensed for free personal and commercial use. If you&#x27;d like to use these fonts then you can check the licenses and download the font for free.</p>
            </div>
          </div>
        </div>
      </div>
