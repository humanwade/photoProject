...
<html data-wf-page="6634a93befaafa41dc30c162" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Changelog | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Changelog | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Changelog | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
...
<body>
  ...
  <div style="opacity:0" class="pages-wrapper">
      ...
      <div class="container">
        <div class="navbar-wrapper">
          <div class="split-contant navbar-left">
            <a href="${pageContext.request.contextPath}/resources/index.do" class="navbar-logo-wrap w-nav-brand"><img src="${pageContext.request.contextPath}/resources/images/navbar-icon.svg" loading="lazy" alt="" class="navbar-logo"></a>
          </div>
                    ...
                    <div class="home-dropdown-links-wrap-2">
                      <div class="page-dropdown-list-wrap">
                        <div class="dropdown-grid-2">
                          <a href="${pageContext.request.contextPath}/resources/home-pages/home-01.do" class="dropdown-nav-link w-inline-block">
                            <div>Home 01</div>
                          </a>
                          <a href="${pageContext.request.contextPath}/resources/home-pages/home-02.do" class="dropdown-nav-link w-inline-block">
                            <div>Home 02</div>
                          </a>
                        </div>
                      </div>
                        ...
                        <div class="pages-dropdown-flex">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="dropdown-list-wrapper">
                              ...
                              <a href="changelog.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
                                <div>Changelog</div>
                              </a>
                              <a href="license.do" class="dropdown-nav-link w-inline-block">
                                <div>License</div>
                              </a>
                              <a href="style-guide.do" class="dropdown-nav-link w-inline-block">
                                <div>Style Guide</div>
                              </a>
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">Changelog</h2>
          <div class="breadcrumb-wrapper">
            <a href="../home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="changelog.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Changelog</div>
            </a>
          </div>
        </div>
    ...
    <section class="section changelog">
      <div class="container">
        <div class="changelog-contant-wrapper">
          <div class="changelog-wrapper">
            <div data-w-id="da542fe3-f91f-de29-0df5-fbcdf5f35783" style="opacity:0" class="changelog-single-wrapper">
              <div class="changelog-date-wrapper">
                <div class="changelog-date-text-block">08th june, 2022</div>
                <div class="changelog-circle">
                  <div class="circle-changelog"></div>
                </div>
              </div>
              <div class="changelog-text-wrapper">
                <div class="changelog-description-wrapper">
                  <div class="changelog-description-contant">
                    <h2 class="changelog-title">V 5.0.0</h2>
                    <ul role="list" class="changelog-facility-wrap">
                      <li class="facility-item-wrapper">
                        <div class="facility-circle"></div>
                        <div class="facility-item">Pretium ut lacinia in, elementum id enim Praesent</div>
                      </li>
                      <li class="facility-item-wrapper">
                        <div class="facility-circle"></div>
                        <div class="facility-item">Cras ultricies ligula sed magna dictum porta</div>
                      </li>
                      <li class="facility-item-wrapper">
                        <div class="facility-circle"></div>
                        <div class="facility-item">Quisque velit pretium ut lacinia elementum pretium</div>
                      </li>
                    </ul>
                  </div>
                  <div class="changelog-border"></div>
                </div>
              </div>
            </div>
            <div data-w-id="da542fe3-f91f-de29-0df5-fbcdf5f3579c" style="opacity:0" class="changelog-single-wrapper">
              <div class="changelog-date-wrapper">
                <div class="changelog-date-text-block">22th july, 2023</div>
                <div class="changelog-circle">
                  <div class="circle-changelog"></div>
                </div>
              </div>
              <div class="changelog-text-wrapper">
                <div class="changelog-description-wrapper">
                  <div class="changelog-description-contant">
                    <h2 class="changelog-title">V 4.5.0</h2>
                    <ul role="list" class="changelog-facility-wrap">
                      <li class="facility-item-wrapper">
                        <div class="facility-circle"></div>
                        <div class="facility-item">Pretium ut lacinia in, elementum id enim Praesent</div>
            ...
            <div data-w-id="da542fe3-f91f-de29-0df5-fbcdf5f357b5" style="opacity:0" class="changelog-single-wrapper">
              <div class="changelog-date-wrapper">
                <div class="changelog-date-text-block">12th march, 2023</div>
                <div class="changelog-circle">
                  <div class="circle-changelog"></div>
                </div>
              </div>
              <div class="changelog-text-wrapper mg-bottom-0px">
                <div class="changelog-description-wrapper">
                  <div class="changelog-description-contant">
                    <h2 class="changelog-title">V 4.0.0</h2>
                    <ul role="list" class="changelog-facility-wrap">
                      <li class="facility-item-wrapper">
                        <div class="facility-circle"></div>
                        <div class="facility-item">Pretium ut lacinia in, elementum id enim Praesent</div>
      ...
      <div class="container">
        <div class="footer-top">
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443d9" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                <a href="style-guide.do" class="single-footer-link w-inline-block">
                ...
                <a href="license.do" class="single-footer-link w-inline-block">
                  <div class="footer-link-text">Licenses</div>
                </a>
                <a href="changelog.do" aria-current="page" class="single-footer-link w-inline-block w--current">
        ...
        <div class="footer-bottom">
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443ee" class="footer-copyright-wrap">
            <div class="footer-copyright">© Copyright - <a href="${pageContext.request.contextPath}/resources/index.do" class="footer-source-link">Zastock</a> | Designed by <a href="https://www.flowzai.com/" target="_blank" class="footer-source-link">Flowzai </a>/ <a href="${pageContext.request.contextPath}/resources/utility-pages/license.do" class="footer-source-link">License</a> - Powered by <a href="https://webflow.com/" target="_blank" class="footer-source-link">Webflow</a>
            </div>
          </div>
