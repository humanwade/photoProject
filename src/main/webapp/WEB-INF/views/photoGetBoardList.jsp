	...
	<section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">사진공유 목록</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="photoGetBoardList.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>사진공유 목록</div>
            </a>
          </div>
        </div>
...
<main>
			...
			<c:forEach items="${photoList}" var="photo">
			    <tr>
			        <td>${photo.picNum}</td>
			        <td>
			            <a href="photoGetBoard.do?PicNum=${photo.picNum}">
			                ${photo.picTitle}
			            </a>
			        </td>
			        ...
			        <td>
			            <c:choose>
			                <c:when test="${photo.picFsize == 0}">
			                    첨부파일없음
			                </c:when>
			                <c:otherwise>
			                    <!-- 썸네일은 고정 이미지(disk.gif), 클릭하면 실제 이미지 미리보기 -->
			                    <a href="${pageContext.request.contextPath}/photoImage/${photo.picEmail}/${photo.picId}" target="_blank">
			                        <img src="${pageContext.request.contextPath}/resources/images/disk.gif" 
			                             alt="image thumbnail" 
			                        ...
			                        ${photo.picFname}
										...
										<div class="btnBox">
                                        	<a href="photoInsertBoard.do" class="boardBtn">글쓰기</a>
                                        </div>
