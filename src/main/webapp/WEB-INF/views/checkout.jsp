...
<html data-wf-page="6634a93befaafa41dc30c163" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Checkout | Zastock | Webflow Ecommerce Website Template</title>
...
<body>
  <div class="pages-wrapper">
      ...
      <div class="container">
        <div class="navbar-wrapper">
          <div class="split-contant navbar-left">
            <a href="index.do" class="navbar-logo-wrap w-nav-brand"><img src="${pageContext.request.contextPath}/resources/images/navbar-icon.svg" loading="lazy" alt="" class="navbar-logo"></a>
          </div>
          ...
          <div class="split-contant navbar-right">
            <div data-open-product="" data-wf-cart-type="leftSidebar" data-wf-cart-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercecartwrapper" data-node-type="commerce-cart-wrapper">
              <a class="w-commerce-commercecartopenlink cart-button w-inline-block" role="button" aria-haspopup="dialog" aria-label="Open cart" data-node-type="commerce-cart-open-link" href="#"><img src="${pageContext.request.contextPath}/resources/images/cart-Icon.svg" loading="lazy" alt="" class="cart-icon">
                <div class="w-commerce-commercecartopenlinkcount quantity-cart">0</div>
              </a>
              <div style="display:none" class="w-commerce-commercecartcontainerwrapper w-commerce-commercecartcontainerwrapper--cartType-leftSidebar cart-wrapper" data-node-type="commerce-cart-container-wrapper">
                <div data-node-type="commerce-cart-container" role="dialog" class="w-commerce-commercecartcontainer cart-container">
                  <div class="w-commerce-commercecartheader cart-header">
                    <h4 class="w-commerce-commercecartheading cart-title">Your Cart</h4>
                    <a class="w-commerce-commercecartcloselink cart-close-button w-inline-block" role="button" aria-label="Close cart" data-node-type="commerce-cart-close-link"><img src="${pageContext.request.contextPath}/resources/images/cart-close-icon.svg" loading="lazy" alt="" class="cart-close-icon"></a>
                  </div>
                  <div class="w-commerce-commercecartformwrapper cart-from-wrapper">
                    <form style="display:none" class="w-commerce-commercecartform" data-node-type="commerce-cart-form">
                      <script type="text/x-wf-template" id="wf-template-d46ee429-031e-e6cf-4cab-0cd377282a36"></script>
                      <div class="w-commerce-commercecartlist cart-list-wrapper" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-d46ee429-031e-e6cf-4cab-0cd377282a36"></div>
      ...
      <div class="container">
        <div class="inner-banner-wrapper">
          ...
          <div class="breadcrumb-wrapper">
            ...
            <a href="checkout.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>Checkout</div>
            </a>
          </div>
        </div>
    ...
    <div data-node-type="commerce-checkout-form-container" data-wf-checkout-query="" data-wf-page-link-href-prefix="" class="w-commerce-commercecheckoutformcontainer checkout-from">
      <div class="w-commerce-commercelayoutcontainer container w-container">
        <div class="w-commerce-commercelayoutmain split-content left">
          <form data-node-type="commerce-checkout-customer-info-wrapper" class="w-commerce-commercecheckoutcustomerinfowrapper checkout-card">
            <div class="w-commerce-commercecheckoutblockheader checkout-block-header">
              <h2 class="title checkout">Customer Info</h2>
              <div class="checkout-required-text">* Required</div>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content"><label for="wf-ecom-email" class="w-commerce-commercecheckoutlabel checkout-field-label">Email *</label><input id="wf-ecom-email" class="w-commerce-commercecheckoutemailinput input checkout" type="text" name="email" required=""></fieldset>
          </form>
          <form data-node-type="commerce-checkout-shipping-address-wrapper" class="w-commerce-commercecheckoutshippingaddresswrapper checkout-card">
            <div class="w-commerce-commercecheckoutblockheader checkout-block-header">
              <h2 class="title checkout">Shipping Address</h2>
              <div class="checkout-required-text">* Required</div>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content"><label for="wf-ecom-shipping-name" class="w-commerce-commercecheckoutlabel checkout-field-label">Full Name *</label><input id="wf-ecom-shipping-name" class="w-commerce-commercecheckoutshippingfullname input checkout" name="name" type="text" required=""><label for="wf-ecom-shipping-address" class="w-commerce-commercecheckoutlabel checkout-field-label">Street Address *</label><input id="wf-ecom-shipping-address" class="w-commerce-commercecheckoutshippingstreetaddress input checkout" name="address_line1" type="text" required=""><input aria-label="Shipping address optional" class="w-commerce-commercecheckoutshippingstreetaddressoptional input checkout" name="address_line2" type="text">
              <div class="w-commerce-commercecheckoutrow row">
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-city" class="w-commerce-commercecheckoutlabel checkout-field-label">City *</label><input id="wf-ecom-shipping-city" class="w-commerce-commercecheckoutshippingcity input checkout" name="address_city" type="text" required=""></div>
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-state" class="w-commerce-commercecheckoutlabel checkout-field-label">State/Province</label><input id="wf-ecom-shipping-state" class="w-commerce-commercecheckoutshippingstateprovince input checkout" name="address_state" type="text"></div>
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-shipping-zip" class="w-commerce-commercecheckoutlabel checkout-field-label">Zip/Postal Code *</label><input id="wf-ecom-shipping-zip" data-node-type="commerce-checkout-shipping-zip-field" class="w-commerce-commercecheckoutshippingzippostalcode input checkout" name="address_zip" type="text" required=""></div>
              </div><label for="wf-ecom-shipping-country" class="w-commerce-commercecheckoutlabel checkout-field-label">Country *</label><select id="wf-ecom-shipping-country" class="w-commerce-commercecheckoutshippingcountryselector input checkout" name="address_country">
          ...
          <form data-node-type="commerce-checkout-shipping-methods-wrapper" class="w-commerce-commercecheckoutshippingmethodswrapper checkout-card">
            <div class="w-commerce-commercecheckoutblockheader checkout-block-header">
              <h2 class="title checkout">Shipping Method</h2>
            </div>
            <fieldset class="checkout-block-content">
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e757000000000042">%3Clabel%20class%3D%22w-commerce-commercecheckoutshippingmethoditem%20shipping-method%22%3E%3Cinput%20required%3D%22%22%20type%3D%22radio%22%20name%3D%22shipping-method-choice%22%2F%3E%3Cdiv%20class%3D%22w-commerce-commercecheckoutshippingmethoddescriptionblock%22%3E%3Cdiv%20class%3D%22w-commerce-commerceboldtextblock%22%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Flabel%3E</script>
              <div data-node-type="commerce-checkout-shipping-methods-list" class="w-commerce-commercecheckoutshippingmethodslist shipping-method-list" data-wf-collection="database.commerceOrder.availableShippingMethods" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e757000000000042"><label class="w-commerce-commercecheckoutshippingmethoditem shipping-method"><input required="" type="radio" name="shipping-method-choice">
          ...
          <div class="w-commerce-commercecheckoutpaymentinfowrapper checkout-card">
            <div class="w-commerce-commercecheckoutblockheader checkout-block-header">
              <h2 class="title checkout">Payment Info</h2>
              <div class="checkout-required-text">* Required</div>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content"><label for="" class="w-commerce-commercecheckoutlabel checkout-field-label">Card Number *</label>
              <div data-wf-stripe-element-type="cardNumber" data-wf-style-map="{}" style="position:relative" class="w-commerce-commercecheckoutcardnumber input checkout">
                <div></div>
                <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
              </div>
              <div class="w-commerce-commercecheckoutrow row">
                <div class="w-commerce-commercecheckoutcolumn"><label for="" class="w-commerce-commercecheckoutlabel checkout-field-label">Expiration Date *</label>
                  <div data-wf-stripe-element-type="cardExpiry" data-wf-style-map="{}" style="position:relative" class="w-commerce-commercecheckoutcardexpirationdate input checkout">
                    <div></div>
                    <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
                  </div>
                </div>
                <div class="w-commerce-commercecheckoutcolumn"><label for="" class="w-commerce-commercecheckoutlabel checkout-field-label">Security Code *</label>
                  <div data-wf-stripe-element-type="cardCvc" data-wf-style-map="{}" style="position:relative" class="w-commerce-commercecheckoutcardsecuritycode input checkout">
                    <div></div>
                    <div style="position:absolute;top:0;left:0;width:100%;height:100%;opacity:0"></div>
                  </div>
                </div>
              </div>
              <div class="w-commerce-commercecheckoutbillingaddresstogglewrapper checkout-billing-address-toggle"><input id="billing-address-toggle" data-node-type="commerce-checkout-billing-address-toggle-checkbox" class="w-commerce-commercecheckoutbillingaddresstogglecheckbox checkout-checkbox" type="checkbox" checked=""><label for="billing-address-toggle" class="w-commerce-commercecheckoutbillingaddresstogglelabel checkout-checkbox-label">Billing address same as shipping</label></div>
            </fieldset>
          </div>
          <form data-node-type="commerce-checkout-billing-address-wrapper" style="display:none" class="w-commerce-commercecheckoutbillingaddresswrapper checkout-card">
            <div class="w-commerce-commercecheckoutblockheader checkout-block-header">
              <h2 class="title checkout">Billing Address</h2>
              <div class="checkout-required-text">* Required</div>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content"><label for="wf-ecom-billing-name" class="w-commerce-commercecheckoutlabel checkout-field-label">Full Name *</label><input id="wf-ecom-billing-name" class="w-commerce-commercecheckoutbillingfullname input checkout" name="name" type="text" required=""><label for="wf-ecom-billing-address" class="w-commerce-commercecheckoutlabel checkout-field-label">Street Address *</label><input id="wf-ecom-billing-address" class="w-commerce-commercecheckoutbillingstreetaddress input checkout" name="address_line1" required="" type="text"><input aria-label="Billing address optional" class="w-commerce-commercecheckoutbillingstreetaddressoptional input checkout" name="address_line2" type="text">
              <div class="w-commerce-commercecheckoutrow row">
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-billing-city" class="w-commerce-commercecheckoutlabel checkout-field-label">City *</label><input id="wf-ecom-billing-city" class="w-commerce-commercecheckoutbillingcity input checkout" name="address_city" type="text" required=""></div>
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-billing-state" class="w-commerce-commercecheckoutlabel checkout-field-label">State/Province</label><input id="wf-ecom-billing-state" class="w-commerce-commercecheckoutbillingstateprovince input checkout" name="address_state" type="text"></div>
                <div class="w-commerce-commercecheckoutcolumn"><label for="wf-ecom-billing-zip" class="w-commerce-commercecheckoutlabel checkout-field-label">Zip/Postal Code *</label><input id="wf-ecom-billing-zip" data-node-type="commerce-checkout-billing-zip-field" class="w-commerce-commercecheckoutbillingzippostalcode input checkout" name="address_zip" type="text" required=""></div>
              </div><label for="wf-ecom-billing-country" class="w-commerce-commercecheckoutlabel checkout-field-label">Country *</label><select id="wf-ecom-billing-country" class="w-commerce-commercecheckoutbillingcountryselector input checkout" name="address_country">
                <option value="AF">Afghanistan</option>
                <option value="AX">Aland Islands</option>
                <option value="AL">Albania</option>
                <option value="DZ">Algeria</option>
          ...
          <div class="w-commerce-commercecheckoutorderitemswrapper checkout-card mg-bottom-0px">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
              <h2 class="title checkout">Items in Order</h2>
            </div>
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e757000000000086"></script>
              <div role="list" class="w-commerce-commercecheckoutorderitemslist order-item-list" data-wf-collection="database.commerceOrder.userItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e757000000000086"></div>
            </fieldset>
          </div>
        </div>
        <div class="w-commerce-commercelayoutsidebar split-content right">
          <div class="w-commerce-commercecheckoutordersummarywrapper checkout-card">
            <div class="w-commerce-commercecheckoutsummaryblockheader checkout-block-header">
            ...
            <fieldset class="w-commerce-commercecheckoutblockcontent checkout-block-content">
              ...
              <script type="text/x-wf-template" id="wf-template-65d47b2761a0aa9412a9e7570000000000a0">%3Cdiv%20class%3D%22w-commerce-commercecheckoutordersummaryextraitemslistitem%22%3E%3Cdiv%3E%3C%2Fdiv%3E%3Cdiv%3E%3C%2Fdiv%3E%3C%2Fdiv%3E</script>
              <div class="w-commerce-commercecheckoutordersummaryextraitemslist" data-wf-collection="database.commerceOrder.extraItems" data-wf-template-id="wf-template-65d47b2761a0aa9412a9e7570000000000a0">
              ...
              <div class="w-commerce-commercecheckoutsummarylineitem">
                <div>Total</div>
                <div class="w-commerce-commercecheckoutsummarytotal checkout-total-price"></div>
              </div>
            </fieldset>
          </div>
          <a href="#" value="Place Order" data-node-type="commerce-checkout-place-order-button" class="w-commerce-commercecheckoutplaceorderbutton submit-button primary-color-1" data-loading-text="Placing Order...">Place Order</a>
      ...
      <div class="container">
        <div class="footer-top">
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443a0" class="footer-details-wrap">
            <a href="index.do" class="footer-logo-wrap w-inline-block"><img src="${pageContext.request.contextPath}/resources/images/footer-logo.svg" loading="lazy" alt="" class="footer-logo"></a>
