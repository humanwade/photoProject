...
<html data-wf-page="6634a93befaafa41dc30c149" data-wf-site="6634a93aefaafa41dc30c070">
<head>
  <meta charset="utf-8">
  <title>Not Found | Zastock | Webflow Ecommerce Website Template</title>
  <meta content="Not Found | Zastock | Webflow Ecommerce Website Template" property="og:title">
  <meta content="Not Found | Zastock | Webflow Ecommerce Website Template" property="twitter:title">
                      ...
                      <div class="pages-dropdown-list">
                        <div class="pages-dropdown-flex">
                          ...
                          <div class="pages-dropdown-single-links-wrap">
                            ...
                            <div class="dropdown-list-wrapper">
                              <a href="404.do" aria-current="page" class="dropdown-nav-link w-inline-block w--current">
    ...
    <section class="section inner-banner">
      <div class="container">
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">404 Not Found</h2>
          <div class="breadcrumb-wrapper">
            <a href="home-pages/home-01.do" class="single-breadcrumb-link w-inline-block">
              <div>Home</div>
            </a>
            <div class="single-breadcrumb-link">/</div>
            <a href="404.do" aria-current="page" class="single-breadcrumb-link w-inline-block w--current">
              <div>404 Not Found</div>
            </a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="not-found-wrapper">
          <div class="not-found-card">
            <div data-w-id="162cfdfa-05c3-1113-1a0d-1855d61062c7" style="opacity:0" class="not-found-card-contant"><img src="${pageContext.request.contextPath}/resources/images/not-found-img.svg" alt="" class="not-found-img">
              <h3 class="not-found-title">Page Not Found!</h3>
              <div class="not-found-details">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Quisque velit nisi pretium ut lacinia in.</div>
              <a href="home-pages/home-01.do" class="primary-button redius-0px w-inline-block">
            ...
            <div class="cta-card-contant center">
              ...
              <div class="cta-from-wrap">
                <div class="cta-from-block w-form">
                  <form id="wf-form-Cta-Email-From" name="wf-form-Cta-Email-From" data-name="Cta Email From" method="get" class="cta-from" data-wf-page-id="6634a93befaafa41dc30c149" data-wf-element-id="cdb24e9a-0bd0-0bea-14ef-0cd3b93e5816"><input class="input cta inner w-input" maxlength="256" name="Cta-Email-2" data-name="Cta Email 2" placeholder="Enter your email address" type="email" id="Cta-Email-2" required=""><input type="submit" data-wait="Please wait..." class="submit-button primary-color-1 w-button" value="Browse All Articles"></form>
          ...
          <div data-w-id="35101c2c-ff7c-f7b3-9aa9-ac2f2b9443d9" class="footer-links-wrapper">
            ...
            <div class="footer-links-flex-wrap">
              <div class="single-footer-links-flex-wrap">
                ...
                <a href="404.do" aria-current="page" class="single-footer-link w-inline-block w--current">
