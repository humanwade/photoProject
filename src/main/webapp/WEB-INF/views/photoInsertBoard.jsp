  ...
  <div style="opacity:0" class="pages-wrapper">
	...
	<section class="section inner-banner">
        ...
        <div class="inner-banner-wrapper">
          <h2 class="inner-banner-title">사진등록</h2>
...
<div class="container-fluid px-4">
		...
		<form action="photoSaveBoard.do" method='post' enctype="multipart/form-data"> 
			<table>
				<!-- 2. 각 항목에  name 맞추기 -->
				<tr>
					<td>제목</td>
				...
				<tr>
            		...
            		<td>
                		<select name="PhotoType">
                			<option value="">선택해주세요</option>
		                    <option value="인물사진">인물</option>
		                    <option value="풍경사진">풍경</option>
		                    <option value="반려동물사진">반려동물</option>
		                    <option value="여행사진">여행</option>
		                    <option value="음식사진">음식</option>
                		</select>
            		</td>
        		</tr>
        		<tr>
            		...
            		<td>
                		<select name="ShutterSpeed">
                			<option value="">선택해주세요</option>
		                    <option value="T(타임)">T(타임)</option>
		                    <option value="B(벌브)">B(벌브)</option>
